...
- [X] Implement Search on Device Level from start menu (Explorer Viewer, but with filtered-indices)
- [X] Finalize Search on Device Level
- [X] Add Clippy
- [ ] Implement some Help and Documentation
- [ ] Create Games (Space Invader, PacMan)
- [ ] Add Helicopter Game with three.js
- [ ] Fix Find and Search By indexing stuff
- [ ] Search Should Open Files using the corresponding application
- [X] Add Theme Support
- [ ] Migrate entire project into Signals and NGRX
